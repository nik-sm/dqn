...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        # states = torch.zeros(32, 4, 84, 84, dtype=torch.float32)
        # actions = torch.zeros(32, 1, dtype=torch.long)
        # rewards = torch.zeros(32, dtype=torch.float32)
        # next_states = torch.zeros(32, 4, 84, 84, dtype=torch.float32)
